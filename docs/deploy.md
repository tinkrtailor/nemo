...
module "nautiloop" {
  ...
  control_plane_image = "ghcr.io/tinkrtailor/nautiloop-control-plane:0.7.1"
  agent_base_image    = "ghcr.io/tinkrtailor/nautiloop-agent-base:0.7.1"
  sidecar_image       = "ghcr.io/tinkrtailor/nautiloop-sidecar:0.7.1"
}
```
...
| `control_plane_image` | no | `ghcr.io/tinkrtailor/nautiloop-control-plane:0.7.1` | Control plane image |
| `agent_base_image` | no | `ghcr.io/tinkrtailor/nautiloop-agent-base:0.7.1` | Agent base image |
| `sidecar_image` | no | `ghcr.io/tinkrtailor/nautiloop-sidecar:0.7.1` | Auth sidecar image |
...
terraform apply \
  -var="control_plane_image=ghcr.io/tinkrtailor/nautiloop-control-plane:0.7.1" \
  -var="agent_base_image=ghcr.io/tinkrtailor/nautiloop-agent-base:0.7.1" \
  -var="sidecar_image=ghcr.io/tinkrtailor/nautiloop-sidecar:0.7.1"
```
