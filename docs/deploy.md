...
module "nautiloop" {
  ...
  control_plane_image = "ghcr.io/tinkrtailor/nautiloop-control-plane:0.2.5"
  agent_base_image    = "ghcr.io/tinkrtailor/nautiloop-agent-base:0.2.5"
  sidecar_image       = "ghcr.io/tinkrtailor/nautiloop-sidecar:0.2.5"
}
```
...
| `control_plane_image` | no | `ghcr.io/tinkrtailor/nautiloop-control-plane:0.2.5` | Control plane image |
| `agent_base_image` | no | `ghcr.io/tinkrtailor/nautiloop-agent-base:0.2.5` | Agent base image |
| `sidecar_image` | no | `ghcr.io/tinkrtailor/nautiloop-sidecar:0.2.5` | Auth sidecar image |
...
terraform apply \
  -var="control_plane_image=ghcr.io/tinkrtailor/nautiloop-control-plane:0.2.5" \
  -var="agent_base_image=ghcr.io/tinkrtailor/nautiloop-agent-base:0.2.5" \
  -var="sidecar_image=ghcr.io/tinkrtailor/nautiloop-sidecar:0.2.5"
```
