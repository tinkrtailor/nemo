...
module "nautiloop" {
  ...
  control_plane_image = "ghcr.io/tinkrtailor/nautiloop-control-plane:0.2.3"
  agent_base_image    = "ghcr.io/tinkrtailor/nautiloop-agent-base:0.2.3"
  sidecar_image       = "ghcr.io/tinkrtailor/nautiloop-sidecar:0.2.3"
}
```
...
| `control_plane_image` | no | `ghcr.io/tinkrtailor/nautiloop-control-plane:0.2.3` | Control plane image |
| `agent_base_image` | no | `ghcr.io/tinkrtailor/nautiloop-agent-base:0.2.3` | Agent base image |
| `sidecar_image` | no | `ghcr.io/tinkrtailor/nautiloop-sidecar:0.2.3` | Auth sidecar image |
...
terraform apply \
  -var="control_plane_image=ghcr.io/tinkrtailor/nautiloop-control-plane:0.2.3" \
  -var="agent_base_image=ghcr.io/tinkrtailor/nautiloop-agent-base:0.2.3" \
  -var="sidecar_image=ghcr.io/tinkrtailor/nautiloop-sidecar:0.2.3"
```
