...
module "nautiloop" {
  ...
  control_plane_image = "ghcr.io/tinkrtailor/nautiloop-control-plane:0.2.4"
  agent_base_image    = "ghcr.io/tinkrtailor/nautiloop-agent-base:0.2.4"
  sidecar_image       = "ghcr.io/tinkrtailor/nautiloop-sidecar:0.2.4"
}
```
...
| `control_plane_image` | no | `ghcr.io/tinkrtailor/nautiloop-control-plane:0.2.4` | Control plane image |
| `agent_base_image` | no | `ghcr.io/tinkrtailor/nautiloop-agent-base:0.2.4` | Agent base image |
| `sidecar_image` | no | `ghcr.io/tinkrtailor/nautiloop-sidecar:0.2.4` | Auth sidecar image |
...
terraform apply \
  -var="control_plane_image=ghcr.io/tinkrtailor/nautiloop-control-plane:0.2.4" \
  -var="agent_base_image=ghcr.io/tinkrtailor/nautiloop-agent-base:0.2.4" \
  -var="sidecar_image=ghcr.io/tinkrtailor/nautiloop-sidecar:0.2.4"
```
